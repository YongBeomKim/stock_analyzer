# Generated by Django 3.0.5 on 2021-03-17 13:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stock_market_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rest_api.StockMarket')),
            ],
        ),
        migrations.CreateModel(
            name='StockItem',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('reg_date', models.DateField(default=datetime.datetime(2021, 3, 17, 13, 47, 15, 540865, tzinfo=utc), null=True)),
